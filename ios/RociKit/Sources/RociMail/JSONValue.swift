...
/// A dynamically-typed JSON value. JMAP method arguments are heterogenous
/// (`[name, arguments, callId]` triplets), so the request/response layer works
/// in `JSONValue` and typed mappers sit on top.
...
extension JSONValue {
    ...
    /// Array of strings, dropping non-string members.
